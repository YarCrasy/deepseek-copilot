...
export const tools = {
  tools: {
    ...
    autoApproveModeDescription: "All non-disabled tools are available. DeepSeek decides and executes them immediately without heuristic confirmation. Use only in trusted workspaces.",
