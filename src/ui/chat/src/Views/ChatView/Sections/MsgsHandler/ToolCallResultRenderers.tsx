...
import type { StructuredToolResult } from "../../utils/filePreview";
import { detectFileType, detectLanguage, extractFilename, formatSize, looksBinary, parseSearchResults } from "../../utils/filePreview";
