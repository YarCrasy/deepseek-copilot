...
import { appendProjectInstructionsToSystemPrompt, loadProjectInstructions } from "@/vscode-api/configuration/projectInstructions";
import { HistoryManager, SettingsManager, SecretsManager } from "@/vscode-api/storage";
